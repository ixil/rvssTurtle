...
;//! \htmlinclude objMsg.msg.html

(cl:defclass <objMsg> (roslisp-msg-protocol:ros-message)
  ((header
    :reader header
    :initarg :header
...
(cl:defclass objMsg (<objMsg>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <objMsg>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'objMsg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rvss_workshop-msg:<objMsg> is deprecated: use rvss_workshop-msg:objMsg instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <objMsg>))
...
(cl:defmethod Zrobot-val ((m <objMsg>))
...
(cl:defmethod Xrobot-val ((m <objMsg>))
...
(cl:defmethod label-val ((m <objMsg>))
...
(cl:defmethod covariance-val ((m <objMsg>))
  ...
  (covariance m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <objMsg>) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <objMsg>) istream)
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<objMsg>)))
  "Returns string type for a message object of type '<objMsg>"
  "rvss_workshop/objMsg")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'objMsg)))
  "Returns string type for a message object of type 'objMsg"
  "rvss_workshop/objMsg")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<objMsg>)))
  "Returns md5sum for a message object of type '<objMsg>"
  "92039726cacaf0739b94657d27987f60")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'objMsg)))
  "Returns md5sum for a message object of type 'objMsg"
  "92039726cacaf0739b94657d27987f60")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<objMsg>)))
  "Returns full string definition for message of type '<objMsg>"
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'objMsg)))
  "Returns full string definition for message of type 'objMsg"
  (cl:format cl:nil "Header header~%float32 Zrobot~%float32 Xrobot~%uint8 label~%float32[] covariance~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <objMsg>))
  (cl:+ 0
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <objMsg>))
